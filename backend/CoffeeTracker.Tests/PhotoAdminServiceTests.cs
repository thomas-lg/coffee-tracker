...
public class PhotoAdminServiceTests
{
    ...
    {
        var service = new PhotoAdminService(
    ...
    public async Task DeleteAsync_deletes_unused_but_skips_a_referenced_path()
    {
        ...
        var service = new PhotoAdminService(storage, new FakeCoffeeRepo("photos/used.jpg"));
    ...
    public async Task DeleteAsync_skips_paths_that_are_not_stored()
    {
        ...
        var service = new PhotoAdminService(storage, new FakeCoffeeRepo());
