...
import { RELOAD, authInterceptor } from './auth.interceptor';
...
describe('authInterceptor', () => {
  ...
  it('logs out and redirects to /login on a 401 from the API itself', () => {
  ...
  it('does not redirect or reload on a 401 that opted out via SKIP_AUTH_REDIRECT', () => {
