...
@Component({
  ...
  template: `
    @if (interactive()) {
      <div class="inline-flex gap-1" role="group" aria-label="Rate this coffee">
        @for (n of stars; track n) {
          <button
            ...
            class="text-2xl leading-none transition-transform hover:scale-110 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-crema"
      ...
      <span class="relative inline-block text-base leading-none tracking-[2px]" [attr.aria-label]="label()">
